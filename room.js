...
(function() {
  var Ball, Vx0, Vy0, Wall, all_balls, all_walls, animate, canvas, check_balls_collision, context, get_distance, height, r, random_ball, random_balls, random_hex_color, random_hor_wall, random_int, random_vert_wall, random_walls, render, step, update, wall_length0, wall_thickness0, wedge_product, width, x0, y0, _ref, _ref1;
  ...
  random_ball = function() {
    return new Ball(random_int(100, width - 100), random_int(100, height - 100), random_int(5, 15), random_int(5, 15), r, random_hex_color());
  };
  ...
  random_vert_wall = function() {
    return new Wall(random_int(100, width - 100), random_int(100, height - 100), wall_thickness0, random_int(100, 300));
  };

  random_hor_wall = function() {
    return new Wall(random_int(100, width - 100), random_int(100, height - 100), random_int(100, 300), wall_thickness0);
  };
